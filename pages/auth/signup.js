...
export default function Signup (){
    ...
    return (
        <>
            <div className='flex flex-col text-white justify-center py-12 sm:px-6 lg:px-8 bg-black min-h-screen'>
                ...
                <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
                    <div className="bg-gray-900 py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        <form onSubmit={onSubmit} className='space-y-6'>
                            ...
                            {hasErrors && (
                                <div className='border-solid py-3 px-5 rounded-md border border-red-500 bg-red-200 text-red-500'>
                                    <p>{form.error}</p>
                                </div>
                            )}

                            <div>
                                <button type='submit' className={classNames('flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2', {
                                    'opacity-60 cursor-not-allowed': signupStatus === FETCH_STATUS.LOADING,
                                })}>
                                    ...
                                    {signupStatus === FETCH_STATUS.LOADING ? 'Signing up...' : 'Sign up'}
                                </button>
                            </div>
                        </form>
                    </div>
