                ...
                <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
                    <div className='bg-gray-900 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
                        <form className='space-y-6' onSubmit={onSubmit}>
                            ...
                            <div>
                                ...
                                <div className='mt-1'>
                                    <input
                                        ...
                                        onChange={onChangeInput}
                                        value={form.password}
                                        className='block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 sm:text-sm text-black'
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <button className={classNames('flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2', {
                                    ...
                                    {signInStatus === FETCH_STATUS.LOADING ? 'Sign In...' : 'Sign in'}
                                </button>
                            </div>
                        </form>
                    </div>
