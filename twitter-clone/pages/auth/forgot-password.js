...
export default function ForgotPassword () {
    ...
    const [forgotPasswordStatus, setForgotPasswordStatus] = useState(FETCH_STATUS.IDLE)
    ...
    const onSubmit = async (e) => {
        ...
        const promise = account.create(email, 'http://localhost:3000/auth/reset-password')
